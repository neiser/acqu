// SVN Info: $Id: TA2TotCSPhysics.h 116 2013-02-06 02:32:22Z mushkar $
#ifndef __TA2TotCSPhysics_h__
#define __TA2TotCSPhysics_h__
...
class TA2TotCSPhysics : public TA2Physics {
protected:
  ...
  // Output
  static const Int_t kBeamPolConst = 239;
...
public:
  TA2TotCSPhysics( const char*, TA2Analysis* );
  virtual ~TA2TotCSPhysics();
