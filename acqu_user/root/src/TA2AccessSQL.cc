...
TA2AccessSQL::TA2AccessSQL(const char* name, TA2Analysis* analysis)	: TA2Physics(name, analysis), fCaLibReader(0), CBEnergyPerRunCorrection(false), fRunNumber(0)
{
...
void TA2AccessSQL::PostInit()
{
	...
	if(fNaI)
	{
		...
		{
			for(int i=0; i<(int)(fNaI->GetNelement()); i++)
